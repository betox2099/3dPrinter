...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {100,100,800,93}  // default steps per unit for Ultimaker
...
#define DEFAULT_ACCELERATION          1250    // X, Y, Z and E acceleration in mm/s^2 for printing moves
#define DEFAULT_RETRACT_ACCELERATION  1250   // E acceleration in mm/s^2 for retracts
