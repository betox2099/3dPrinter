...
#define STRING_CONFIG_H_AUTHOR "(GDL3DBot Prusai3)" // Who made the changes.
...
#define HOMING_FEEDRATE {50*40, 50*40, 5*30, 0}  // set the homing speeds (mm/min)

// default settings

#define DEFAULT_AXIS_STEPS_PER_UNIT   {87.48,87.48,2577.3,93}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {250, 250, 5, 25}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {1000,1000,100,8000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.
